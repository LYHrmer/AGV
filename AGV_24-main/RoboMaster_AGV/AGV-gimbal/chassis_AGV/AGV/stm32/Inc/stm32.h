...
typedef struct {
	ExtU_stm32  rudder_in;
	ExtY_stm32  rudder_out; 
	DW_stm32    rudder_param;
	stm32_PID_t   stm32_PID_param;
}Rudder_control;
...
extern void stm32_pid_init(void);

extern void Matlab_PID_Calc(fp32 angle_set,fp32 angle_feedback,fp32 speed_feedback,Rudder_control*rudder_PID);
