...
//void CAN_CMD_cap(uint8_t temPower)//向超级电容控制板发送充电功率
//{
//  capid_tx_message.StdId = CAN_CTRL_FREAM_ID;
//  capid_tx_message.IDE = CAN_ID_STD;
//  capid_tx_message.RTR = CAN_RTR_DATA;
//  capid_tx_message.DLC = 0x08;
//	cap_data.p_set = temPower;
//	cap_data.power_source = CAPACITY;// BATTERY直接用电池
//	cap_data.out_auto_en = 1;// 0
//	cap_data.wireless_en = 1;
//	cap_data.freq_feedback = 100;

//	append_CRC8_check_sum((uint8_t *)&cap_data,sizeof(cap_data));
//  HAL_CAN_AddTxMessage(&CAPID_CAN, &capid_tx_message, (uint8_t *)&cap_data, &cap_send_mail_box);
//}
