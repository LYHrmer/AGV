...
#define PITCH_RC_SEN  0.000005f //0.0050.000005f
...
#define GIMBAL_PITCH_MAX_ENCODE 8000//0x004D
//云台pitch轴最小相对角
#define GIMBAL_PITCH_MIN_ENCODE 2//0x1796
...
//云台yaw轴中值
#define GIMBAL_YAW_OFFSET_ENCODE 2256
//yaw轴后侧中值
...
//线性控制器前馈系数
#define YAW_FEED_FORWARD 0.97f
#define PITCH_FEED_FORWARD 0.97f
#define YAW_D 0.0f//15.0
//角度误差项系数
#define K_YAW_ANGLE_ERROR 	1000.0f//
#define K_PITCH_ANGLE_ERROR 350000//350000.0f//

//速度项系数
#define K_YAW_ANGLE_SPEED		1000.0f//9000.0f//
#define K_PITCH_ANGLE_SPEED 14000.0f//5000
...
#define PITCH_ABS_MAX 0.279
#define PITCH_ABS_MIN -0.65
...
#define DM4310_POS_MAX 0.22
#define DM4310_POS_MIN -0.6
//pitch轴绝对角度控制PID
#define PITCH_ABSLOUTE_ANGLE_PID_KP                     0.021f
#define PITCH_ABSLOUTE_ANGLE_PID_KI                     0.000475f
#define PITCH_ABSLOUTE_ANGLE_PID_KD                     0.00003f
#define PITCH_ABSLOUTE_ANGLE_PID_KF                     0.00006f
...
typedef struct
{
    ...
    gimbal_motor_second_order_linear_controller_t gimbal_motor_second_order_linear_controller;
	  ...
	  PID_control YAW_Absloute_Angle_PID;
		PID_control yaw_abs_PID;
    gimbal_motor_mode_e gimbal_motor_mode;
    gimbal_motor_mode_e last_gimbal_motor_mode;
	
		GM6020_Motor_t yaw_motor;
		DM4310_Motor_t pitch_motor;
