...
{
	stm32_U_pitch_auto.P_P=1100;//   1100;
...
{
	stm32_U_pitch.P_P=1000;//1021;
	stm32_U_pitch.P_I=0;
	stm32_U_pitch.P_D=14;//30;//10
	stm32_U_pitch.P_N=5;
	stm32_U_pitch.S_P=106;//110;
	stm32_U_pitch.S_I=0;//1;
	stm32_U_pitch.S_D=3;//10;
	stm32_U_pitch.S_N=35;//30;
}
...
{   
  ...
  stm32_pid_yaw.rtb_FilterDifferentiatorTF = stm32_U.P_N * 0.0005f;
  ...
  stm32_pid_yaw.rtb_FilterDifferentiatorTF = stm32_U.S_N * 0.0005f;
  ...
  stm32_pid_yaw.rtb_FilterDifferentiatorTF = stm32_U.angle_set - stm32_U.angle_feedback;
  ...
  stm32_pid_yaw.rtb_IProdOut = stm32_pid_yaw.rtb_FilterDifferentiatorTF * stm32_U.P_I;
  stm32_pid_yaw.Integrator = 0.0005f * stm32_pid_yaw.rtb_IProdOut + stm32_DW.Integrator_DSTATE;
  stm32_pid_yaw.TmpSignalConversionAtFilterDifferentiatorTFInport2_idx_1 =
    stm32_pid_yaw.rtb_FilterDifferentiatorTF * stm32_U.P_D -
    stm32_pid_yaw.TmpSignalConversionAtFilterDifferentiatorTFInport2_idx_1 *
  ...
  stm32_pid_yaw.rtb_Sum1 = ((stm32_pid_yaw.TmpSignalConversionAtFilterDifferentiatorTFInport2_idx_1 +
               -stm32_DW.FilterDifferentiatorTF_states) * stm32_pid_yaw.rtb_Sum1 * stm32_U.P_N
              + (stm32_pid_yaw.rtb_FilterDifferentiatorTF * stm32_U.P_P + stm32_pid_yaw.Integrator)) -
    stm32_U.speed_feedback;
  stm32_pid_yaw.rtb_FilterDifferentiatorTF = stm32_pid_yaw.rtb_Sum1 * stm32_U.S_D -
    stm32_pid_yaw.TmpSignalConversionAtFilterDifferentiatorTFInport2_c_idx_1 *
  ...
  stm32_Y_yaw.Out1 = (stm32_pid_yaw.rtb_FilterDifferentiatorTF +
                  -stm32_DW.FilterDifferentiatorTF_states_o) * stm32_pid_yaw.rtb_Reciprocal *
    stm32_U.S_N + (stm32_pid_yaw.rtb_Sum1 * stm32_U.S_P + stm32_pid_yaw.Integrator_d);
	
	if(stm32_Y_yaw.Out1>=30000) stm32_Y_yaw.Out1=30000;
	else if(stm32_Y_yaw.Out1<=-30000) stm32_Y_yaw.Out1=-30000;
  stm32_DW.Integrator_DSTATE = 0.0005f * stm32_pid_yaw.rtb_IProdOut + stm32_pid_yaw.Integrator;
  stm32_DW.FilterDifferentiatorTF_states =
    stm32_pid_yaw.TmpSignalConversionAtFilterDifferentiatorTFInport2_idx_1;
  stm32_DW.FilterDifferentiatorTF_states_o = stm32_pid_yaw.rtb_FilterDifferentiatorTF;
...
void stm32_step_shoot(fp32 speedset,fp32 speedback,uint8_t id)
{
	if(id == 0)
	{
		...
		stm32_Y_fric.out_shoot[0] = (TmpSignalConversionAtFilterDifferentiatorTFInport2_idx_1 +
  ...
  stm32_Y_fric.out_shoot[1] = (TmpSignalConversionAtFilterDifferentiatorTFInport2_idx_1 +
