...
extern ExtY_stm32 stm32_Y_fric;
...
extern void stm32_pid_init_yaw(void);  //yaw;
extern void stm32_pid_init_pitch(void);  //pitch
extern void stm32_step_yaw(fp32 angle_set,fp32 angle_feedback,fp32 speed_feedback);
...
extern void stm32_step_shoot(fp32 speedset,fp32 speedback,uint8_t id);
