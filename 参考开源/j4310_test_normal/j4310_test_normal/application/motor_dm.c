...
void Motor_DM_1_To_4_PID_Calculate(Motor_DM_1_To_4 *motor)
{
	...
	{
//        PID_Omega_Set_Target(&motor->PID_Omega, motor->Target_Omega + motor->Feedforward_Omega);
//        PID_Omega_Set_Now(&motor->PID_Omega, motor->Rx_Data.Now_Omega);
//        PID_Omega_TIM_Adjust_PeriodElapsedCallback(&motor->PID_Omega);
//		
//        motor->Target_Current = PID_Omega_Get_Out(&motor->PID_Omega);
	...
	{
//        PID_Angle_Set_Target(&motor->PID_Angle, motor->Target_Angle);
//        PID_Angle_Set_Now(&motor->PID_Angle, motor->Rx_Data.Now_Angle);
//        PID_Angle_TIM_Adjust_PeriodElapsedCallback(&motor->PID_Angle);
		
//        motor->Target_Omega = PID_Angle_Get_Out(&motor->PID_Angle);
